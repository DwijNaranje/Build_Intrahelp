  ...
  return (
    <div>
      ...
      <div className="py-20 px-6 bg-gray-50 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 max-w-6xl mx-auto text-center">
          <div>
            ...
            <p className="text-gray-700 text-sm">Business analysis, development, support and development from a single vendor</p>
          </div>
          <div>
            <div className="text-4xl text-blue-600 mb-4">📈</div>
            <h3 className="text-lg font-bold mb-2">Increased business value</h3>
            <p className="text-gray-700 text-sm">The solution is tailored to the market and is able to solve business problems that it faces</p>
          </div>
          <div>
            <div className="text-4xl text-blue-600 mb-4">🏆</div>
            <h3 className="text-lg font-bold mb-2">Uniqueness</h3>
            <p className="text-gray-700 text-sm">The ability to gain a competitive advantage with the help of a unique functionality of the software solution</p>
          </div>
          <div>
            <div className="text-4xl text-blue-600 mb-4">🎖️</div>
            <h3 className="text-lg font-bold mb-2">Lifetime warranty</h3>
            <p className="text-gray-700 text-sm">To the software solution</p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 px-6 bg-white text-center">
        ...
        <button 
          onClick={() => navigate("/contact")}
          className="bg-red-600 hover:bg-red-700 transition px-6 py-3 text-white text-lg font-semibold rounded mb-12"
        >
          Contact us
        </button>

        <div className="flex flex-col md:flex-row gap-6 justify-center items-center text-sm md:text-base">
          <button onClick={() => navigate("/portfolio")} className="bg-blue-100 text-blue-700 px-6 py-2 rounded-md shadow hover:bg-blue-200 transform hover:scale-105 transition">
            PoC for Startups →
          </button>
          <button onClick={() => navigate("/portfolio")} className="bg-blue-100 text-blue-700 px-6 py-2 rounded-md shadow hover:bg-blue-200 transform hover:scale-105 transition">
